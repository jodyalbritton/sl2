...
defmodule SearchlightWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: SearchlightWeb.Coherence.EmailView, layout: {SearchlightWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
