defmodule SearchlightWeb.Coherence.ConfirmationController do
  @moduledoc """
  ...
  alias Ecto.DateTime
  alias Searchlight.Coherence.Schemas
  ...
  # We want to change the layout for registration/sign in/ password
  plug :put_layout, "base_app.html"
