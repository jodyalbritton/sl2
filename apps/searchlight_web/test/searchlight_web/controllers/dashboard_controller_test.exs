defmodule SearchlightWeb.DashboardControllerTest do
  use SearchlightWeb.ConnCase

  alias Searchlight.DashManager

  @create_attrs %{default: true, name: "some name", settings: %{}, shareable: true}
  ...
  def fixture(:dashboard) do
    {:ok, dashboard} = DashManager.create_dashboard(@create_attrs)
    dashboard
  end
